...
The code for all the steps is contained `project.py`. I have created a global function for this step and the function name is `calibration_pipeline` this function is in lines between 271 and 288. 
